...
var trainsApp = angular.module('trainsApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'trainsAppUtils', 'pascalprecht.translate', 'truncate']);
